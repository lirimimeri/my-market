...
const Profits = lazy(() => import('./components/Profits/Profits'))
                    ...
                    <div>
                        <Suspense fallback={<PageLoader/>}>
                            <Switch location={location}>
                                ...
                                <Route path="/articles" component={waitFor(Articles)}/>
                                <Route path="/suppliers" component={waitFor(Suppliers)}/>
                                <Route path="/profits" component={waitFor(Profits)}/>
